	...
	namespace matrix {
		...
		class LinearOperator {
		  ...
		  public:
			 ...
			 * - GPU acceleration: false
			 */
			[[nodiscard]] std::function<matrix::Dense<Float>(const matrix::Dense<Float>&)>
			...
			void set_matmul_dense(
				const std::function<matrix::Dense<Float>(const matrix::Dense<Float>&)>& MATMUL);
			...
			void set_rmatmul_dense(
				const std::function<matrix::Dense<Float>(const matrix::Dense<Float>&)>& RMATMUL);
