	...
	namespace matrix {
		...
		class COO {
		  ...
		  public:
			 ...
			 * - GPU acceleration: false
			 **/
			COO(const size_t M, const size_t N, const size_t NNZ, const int* row, const int* col,
				const Float* value);
			 ...
			 * - GPU acceleration: false
			 **/
			COO(const size_t M, const size_t N, const size_t NNZ, const std::vector<int>& row,
				const std::vector<int>& col, const std::vector<Float>& value) {
				this = COO(M, N, NNZ, row.data(), col.data(), value.data());
			}

			/**
			 * @brief Create COO matrix from mathhole::vector
			 * @param M # of row
			 * @param N # of col
			 * @param NNZ # of non-zero elements
			 * @param row row index, which stores the row numbers of the non-zero elements
			 ...
			 **/
			COO(const size_t M, const size_t N, const size_t NNZ, const std::vector<int>& row,
				const std::vector<int>& col, const vector<Float>& value) {
			 ...
			 **/
			COO(const size_t M, const size_t N, const size_t NNZ, const std::vector<int>& row,
				const std::vector<int>& col, const std::vector<Float>& value, const size_t origin) {
			 ...
			 * - GPU acceleration: false
			 **/
			[[nodiscard]] std::vector<int>& get_row_ptr() {
				return row_index;
			}
			 ...
			 * - GPU acceleration: false
			 **/
			[[nodiscard]] std::vector<int>& get_col_ind() {
				return col_index;
			}
