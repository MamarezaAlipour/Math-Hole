...
namespace mathhole {
	...
	class view1D {
	  ...
	  public:
		...
		/**
		 * @brief create view1D(start:end) from mathhole::vector
		 * @param x view1D create from mathhole::vector
		...
		/**
		 * @brief create view1D(start:end) from mathhole::matrix::Dense
		 * @param x view1D create from mathhole::matrix::Dense
		 * @param start start position (x.first + start)
		 * @param end end position (x.last + end)
		 * @note
		 * - # of computation: 1
		 ...
		 * - # of computation: 1
		 **/
		[[nodiscard]] size_t get_first() const {
			return first;
		}
		 ...
		 * - # of computation: 1
		 **/
		[[nodiscard]] size_t get_last() const {
			return last;
		}
