...
#undef _HAS_CPP17
#endif
#include "mathhole_dense.hpp"
#include "mathhole_logger.hpp"
#include "mathhole_matrix.hpp"
#include "mathhole_vector.hpp"
#include "mathhole_view1D.hpp"
#include <initializer_list>

// error code
#define MATHHOLE_SOLVER_SUCCESS 0
#define MATHHOLE_SOLVER_SIZE_ERROR -1
#define MATHHOLE_SOLVER_MAXITER -2
#define MATHHOLE_SOLVER_BREAKDOWN -3
#define MATHHOLE_SOLVER_RESIDUAL_NAN -4
#define MATHHOLE_SOLVER_NOT_IMPL -10

/**
 * @brief mathhole namespaces
 */
namespace mathhole {
	/**
	 * @brief mathhole utilities
	 */
	namespace util {
		/**
		 * @addtogroup utils
		 ...
		 * @param x mathhole vector (size N)
		 * @param y mathhole vector (size M)
		 * @note
		 ...
		 * @ingroup errcheck
		 * @note
		 * - MATHHOLE_SOLVER_SUCCESS 0
		 * - MATHHOLE_SOLVER_SIZE_ERROR -1
		 * - MATHHOLE_SOLVER_MAXITER -2
		 * - MATHHOLE_SOLVER_BREAKDOWN -3
		 * - MATHHOLE_SOLVER_RESIDUAL_NAN -4
		 * - MATHHOLE_SOLVER_NOT_IMPL -10
		 */
		 ...
		 * @param x mathhole vector
		 * @param y mathhole vector
		 ...
		 **/
		template <typename T>
		[[nodiscard]] matrix::COO<T> eye(const int M);
		 ...
		 **/
		template <typename T>
		[[nodiscard]] matrix::COO<T> frank_matrix(const int& M);
		 ...
		 */
		template <typename T>
		[[nodiscard]] T toeplitz_plus_hankel_matrix_eigenvalue(const int& M, int N, T a0, T a1,
															   T a2, T b0, T b1, T b2);
