...
namespace mathhole {
	...
	class vector {
	  ...
	  public:
		...
		/**
		 * @brief copy from mathhole::vector
		 * @param vec input mathhole::vector
		 * @note
		 * - # of computation: N
		 * - Multi-threading: true
		...
		/**
		 * @brief copy from mathhole::view1D from vector
		 * @param vec input mathhole::view1D from vector
		 * @note
		 * - # of computation: N
		 * - Multi-threading: true
		 * - GPU acceleration: true
		...
		/**
		 * @brief copy from mathhole::view1D from mathhole::matrix::Dense
		 * @param vec input mathhole::view1D from mathhole::matrix::Dense
		 * @note
		 * - # of computation: N
		 * - Multi-threading: true
		 * - GPU acceleration: true
		 ...
		 * - GPU acceleration: true
		 **/
		[[nodiscard]] bool get_device_mem_stat() const {
			return gpu_status;
		}
		 ...
		 * - # of computation: 1
		 **/
		[[nodiscard]] size_t get_nnz() const {
			return val.size();
		}
		...
		/**
		 * @brief copy vector, It is same as copy ( Copy the memory on CPU and GPU )
		 * @param vec source view1D from mathhole::vector
		 * @return output vector
		 * @note
		 * - # of computation: N
		 * - Multi-threading: false
		...
		/**
		 * @brief copy vector, It is same as copy ( Copy the memory on CPU and GPU )
		 * @param vec source view1D from mathhole::matrix::Dense
		 * @return output vector
		 * @note
		 * - # of computation: N
		 * - Multi-threading: false
		...
		/**
		 * @brief Comparing matrices (A == mat)
		 * @param vec view1D from mathhole::vector
		 * @param compare_cpu_and_device compare data on both CPU and GPU
		 * @return true or false
		 * @note
		 * - # of computation: N
		...
		/**
		 * @brief Comparing matrices (A == mat)
		 * @param vec view1D from mathhole::matrix::Dense
		 * @param compare_cpu_and_device compare data on both CPU and GPU
		 * @return true or false
		 * @note
		 * - # of computation: N
		...
		/**
		 * @brief Comparing vectors (v == vec)
		 * @param vec view1D from mathhole::vector (size N)
		 * @return true or false
		 * @note
		 * - # of computation: N
		 * - Multi-threading: true
		...
		/**
		 * @brief Comparing vectors (v == vec)
		 * @param vec view1D from mathhole::matrix::Dense (size N)
		 * @return true or false
		 * @note
		 * - # of computation: N
		 * - Multi-threading: true
