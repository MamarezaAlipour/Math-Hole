 !> \brief \b MATHHOLE_SGEMV
 !
 !  Definition:
 !  ===========
 !
 !       SUBROUTINE MATHHOLE_SGEMV(TRANS,M,N,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
 !
 !       .. Scalar Arguments ..
 !       REAL ALPHA,BETA
 ...
 !> \verbatim
 !>
 !> MATHHOLE_SGEMV  performs one of the matrix-vector operations
 !>
 ...
 !
       ...
       END IF
       IF (info.NE.0) THEN
           CALL mathhole_xerbla('MATHHOLE_SGEMV ',info)
           RETURN
       END IF
 !
