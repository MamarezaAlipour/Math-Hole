 !> \brief \b MATHHOLE_STRSV
 !
 !  Definition:
 !  ===========
 !
 !       SUBROUTINE MATHHOLE_STRSV(UPLO,TRANS,DIAG,N,A,LDA,X,INCX)
 !
 !       .. Scalar Arguments ..
 !       INTEGER INCX,LDA,N
 ...
 !> \verbatim
 !>
 !> MATHHOLE_STRSV  solves one of the systems of equations
 !>
 !>    A*x = b,   or   A**T*x = b,
 !>
 ...
 !
       ...
       END IF
       IF (info.NE.0) THEN
           CALL mathhole_xerbla('MATHHOLE_STRSV ',info)
           RETURN
       END IF
 !
