 !> \brief \b MATHHOLE_DGEMM
 !
 !  Definition:
 !  ===========
 !
 !       SUBROUTINE MATHHOLE_DGEMM(TRANSA,TRANSB,M,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
 !
 !       .. Scalar Arguments ..
 ...
 !> \verbatim
 !>
 !> MATHHOLE_DGEMM  performs one of the matrix-matrix operations
 !>
 ...
 !
       ...
       END IF
       IF (info.NE.0) THEN
           CALL mathhole_xerbla('MATHHOLE_DGEMM ',info)
           RETURN
       END IF
 !
